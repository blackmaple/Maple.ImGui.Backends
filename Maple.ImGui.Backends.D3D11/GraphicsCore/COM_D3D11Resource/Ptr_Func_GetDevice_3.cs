...
{
    /// <summary>
    /// Wraps the ID3D11ResourceImp::GetDevice function pointer (VTable slot 3).
    ...
    {
        private readonly delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ResourceImp>, void**, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ResourceImp>, void**, void>)ptr;
        public const string Name = "GetDevice";
        /// <summary>
        /// Invokes ID3D11ResourceImp::GetDevice.
        /// </summary>
        /// <param name="pThis">ID3D11ResourceImp interface pointer.</param>
        /// <param name="arg1">Argument 1.</param>
        public void Invoke(COM_PTR_IUNKNOWN<ID3D11ResourceImp> pThis, void** arg1) => _proc(pThis, arg1);
