...
{
    /// <summary>
    /// Wraps the ID3D11ResourceImp::SetEvictionPriority function pointer (VTable slot 8).
    ...
    {
        private readonly delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ResourceImp>, uint, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ResourceImp>, uint, void>)ptr;
        public const string Name = "SetEvictionPriority";
        /// <summary>
        /// Invokes ID3D11ResourceImp::SetEvictionPriority.
        /// </summary>
        /// <param name="pThis">ID3D11ResourceImp interface pointer.</param>
        /// <param name="arg1">Argument 1.</param>
        public void Invoke(COM_PTR_IUNKNOWN<ID3D11ResourceImp> pThis, uint arg1) => _proc(pThis, arg1);
