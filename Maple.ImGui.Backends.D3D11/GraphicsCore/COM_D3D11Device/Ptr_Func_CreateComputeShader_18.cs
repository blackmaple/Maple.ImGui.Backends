...
{
    /// <summary>
    /// 封装 ID3D11Device::CreateComputeShader 函数指针 (VTable 索引 18)
    /// 创建计算着色器
    ...
    internal readonly unsafe struct Ptr_Func_CreateComputeShader_18(nint ptr) : Hook.Abstractions.IHookMethod
    {
        private readonly delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, void*, nuint, void*, UnsafeOut<UnsafePtr>, HRESULT>
            _proc
            = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, void*, nuint, void*, UnsafeOut<UnsafePtr>, HRESULT>)ptr;
        public const string Name = "CreateComputeShader";
        /// <summary>
        /// 创建计算着色器
        /// </summary>
        ...
        /// <param name="ppComputeShader">接收 ID3D11ComputeShader 接口指针的指针</param>
        ...
        public HRESULT Invoke(
            ...
            void* pClassLinkage,
            UnsafeOut<UnsafePtr> ppComputeShader) => _proc(
                pThis,
                pShaderBytecode,
                BytecodeLength,
                pClassLinkage,
