...
{
    /// <summary>
    /// 封装 ID3D11Device::CreateTexture3D 函数指针 (VTable 索引 6)
    /// 创建 3D 纹理
    ...
    internal readonly unsafe struct Ptr_Func_CreateTexture3D_6(nint ptr) : Hook.Abstractions.IHookMethod
    {
        private readonly delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, UnsafeIn<D3D11_TEXTURE3D_DESC>, UnsafeIn<D3D11_SUBRESOURCE_DATA>, UnsafeOut<UnsafePtr>, HRESULT>
            _proc
            = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, UnsafeIn<D3D11_TEXTURE3D_DESC>, UnsafeIn<D3D11_SUBRESOURCE_DATA>, UnsafeOut<UnsafePtr>, HRESULT>)ptr;
        ...
        /// <param name="ppTexture3D">接收 ID3D11Texture3D 接口指针的指针</param>
        /// <returns>HRESULT</returns>
        public HRESULT Invoke(
            COM_PTR_IUNKNOWN<ID3D11DeviceImp> pThis,
            in D3D11_TEXTURE3D_DESC pDesc,
            in D3D11_SUBRESOURCE_DATA pInitialData,
            UnsafeOut<UnsafePtr> ppTexture3D) => _proc(
                pThis,
                UnsafeIn<D3D11_TEXTURE3D_DESC>.FromIn(in pDesc),
