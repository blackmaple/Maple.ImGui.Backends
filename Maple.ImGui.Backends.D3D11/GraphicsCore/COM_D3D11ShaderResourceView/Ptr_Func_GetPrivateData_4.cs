...
namespace Maple.ImGui.Backends.D3D11.GraphicsCore.COM_D3D11ShaderResourceView
{
    /// <summary>
    /// Wraps the ID3D11ShaderResourceViewImp::GetPrivateData function pointer (VTable slot 4).
    ...
    {
        private readonly delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ShaderResourceViewImp>, global::System.Guid*, uint*, void*, COM_HRESULT> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ShaderResourceViewImp>, global::System.Guid*, uint*, void*, COM_HRESULT>)ptr;
        public const string Name = "GetPrivateData";
        /// <summary>
        /// Invokes ID3D11ShaderResourceViewImp::GetPrivateData.
        /// </summary>
