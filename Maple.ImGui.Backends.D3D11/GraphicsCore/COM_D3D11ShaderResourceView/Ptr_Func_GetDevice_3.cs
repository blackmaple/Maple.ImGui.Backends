...
{
    /// <summary>
    /// Wraps the ID3D11ShaderResourceViewImp::GetDevice function pointer (VTable slot 3).
    ...
    {
        private readonly delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ShaderResourceViewImp>, void**, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D11ShaderResourceViewImp>, void**, void>)ptr;
        public const string Name = "GetDevice";
        /// <summary>
        /// Invokes ID3D11ShaderResourceViewImp::GetDevice.
        /// </summary>
