...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::PSGetSamplers function pointer (VTable slot 75).
    ...
    internal readonly unsafe struct Ptr_Func_PSGetSamplers_75(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::PSGetSamplers.
        /// </summary>
