...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::VSGetShader function pointer (VTable slot 76).
    ...
    internal readonly unsafe struct Ptr_Func_VSGetShader_76(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::VSGetShader.
        /// </summary>
