...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GenerateMips function pointer (VTable slot 54).
    ...
    internal readonly unsafe struct Ptr_Func_GenerateMips_54(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GenerateMips.
        /// </summary>
