...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::PSGetConstantBuffers function pointer (VTable slot 77).
    ...
    internal readonly unsafe struct Ptr_Func_PSGetConstantBuffers_77(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::PSGetConstantBuffers.
        /// </summary>
