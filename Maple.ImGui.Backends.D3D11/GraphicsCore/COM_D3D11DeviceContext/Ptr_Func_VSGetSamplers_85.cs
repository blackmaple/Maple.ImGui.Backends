...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::VSGetSamplers function pointer (VTable slot 85).
    ...
    internal readonly unsafe struct Ptr_Func_VSGetSamplers_85(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::VSGetSamplers.
        /// </summary>
