...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::VSGetConstantBuffers function pointer (VTable slot 72).
    ...
    internal readonly unsafe struct Ptr_Func_VSGetConstantBuffers_72(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::VSGetConstantBuffers.
        /// </summary>
