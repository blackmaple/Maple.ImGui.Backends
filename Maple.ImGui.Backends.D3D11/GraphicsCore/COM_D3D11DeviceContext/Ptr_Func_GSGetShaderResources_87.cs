...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSGetShaderResources function pointer (VTable slot 87).
    ...
    internal readonly unsafe struct Ptr_Func_GSGetShaderResources_87(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSGetShaderResources.
        /// </summary>
