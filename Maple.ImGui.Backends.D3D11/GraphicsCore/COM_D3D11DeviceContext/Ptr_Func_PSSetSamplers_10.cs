...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::PSSetSamplers function pointer (VTable slot 10).
    ...
    internal readonly unsafe struct Ptr_Func_PSSetSamplers_10(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::PSSetSamplers.
        /// </summary>
