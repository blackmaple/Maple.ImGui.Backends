...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSSetShader function pointer (VTable slot 23).
    ...
    internal readonly unsafe struct Ptr_Func_GSSetShader_23(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSSetShader.
        /// </summary>
