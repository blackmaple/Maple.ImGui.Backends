...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSGetSamplers function pointer (VTable slot 88).
    ...
    internal readonly unsafe struct Ptr_Func_GSGetSamplers_88(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSGetSamplers.
        /// </summary>
