...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::OMSetDepthStencilState function pointer (VTable slot 36).
    ...
    internal readonly unsafe struct Ptr_Func_OMSetDepthStencilState_36(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::OMSetDepthStencilState.
        /// </summary>
