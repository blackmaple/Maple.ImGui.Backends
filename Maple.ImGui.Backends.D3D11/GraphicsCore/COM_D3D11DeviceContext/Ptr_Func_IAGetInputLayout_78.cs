...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::IAGetInputLayout function pointer (VTable slot 78).
    ...
    internal readonly unsafe struct Ptr_Func_IAGetInputLayout_78(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::IAGetInputLayout.
        /// </summary>
