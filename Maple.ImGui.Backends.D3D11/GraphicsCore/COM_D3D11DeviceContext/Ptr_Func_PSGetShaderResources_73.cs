...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::PSGetShaderResources function pointer (VTable slot 73).
    ...
    internal readonly unsafe struct Ptr_Func_PSGetShaderResources_73(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::PSGetShaderResources.
        /// </summary>
