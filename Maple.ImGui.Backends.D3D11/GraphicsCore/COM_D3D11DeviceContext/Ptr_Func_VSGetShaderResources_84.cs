...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::VSGetShaderResources function pointer (VTable slot 84).
    ...
    internal readonly unsafe struct Ptr_Func_VSGetShaderResources_84(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::VSGetShaderResources.
        /// </summary>
