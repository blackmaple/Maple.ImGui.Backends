...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSSetSamplers function pointer (VTable slot 32).
    ...
    internal readonly unsafe struct Ptr_Func_GSSetSamplers_32(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSSetSamplers.
        /// </summary>
