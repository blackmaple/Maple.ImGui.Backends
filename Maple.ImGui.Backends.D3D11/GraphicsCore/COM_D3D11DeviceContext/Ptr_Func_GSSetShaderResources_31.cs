...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSSetShaderResources function pointer (VTable slot 31).
    ...
    internal readonly unsafe struct Ptr_Func_GSSetShaderResources_31(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSSetShaderResources.
        /// </summary>
