...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::VSSetConstantBuffers function pointer (VTable slot 7).
    ...
    internal readonly unsafe struct Ptr_Func_VSSetConstantBuffers_7(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::VSSetConstantBuffers.
        /// </summary>
