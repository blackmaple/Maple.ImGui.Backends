...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::DrawIndexedInstancedIndirect function pointer (VTable slot 39).
    ...
    internal readonly unsafe struct Ptr_Func_DrawIndexedInstancedIndirect_39(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        public const string Name = "DrawIndexedInstancedIndirect";
        /// <summary>
        /// Invokes ID3D11DeviceContext::DrawIndexedInstancedIndirect.
        /// </summary>
