...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::Begin function pointer (VTable slot 27).
    ...
    internal readonly unsafe struct Ptr_Func_Begin_27(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::Begin.
        /// </summary>
