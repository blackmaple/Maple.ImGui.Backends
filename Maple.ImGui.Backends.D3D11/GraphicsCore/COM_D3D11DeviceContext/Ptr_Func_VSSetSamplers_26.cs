...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::VSSetSamplers function pointer (VTable slot 26).
    ...
    internal readonly unsafe struct Ptr_Func_VSSetSamplers_26(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::VSSetSamplers.
        /// </summary>
