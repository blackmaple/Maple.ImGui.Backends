...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::PSSetShaderResources function pointer (VTable slot 8).
    ...
    internal readonly unsafe struct Ptr_Func_PSSetShaderResources_8(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::PSSetShaderResources.
        /// </summary>
