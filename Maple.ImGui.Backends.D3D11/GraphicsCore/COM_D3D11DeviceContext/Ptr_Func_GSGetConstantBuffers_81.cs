...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSGetConstantBuffers function pointer (VTable slot 81).
    ...
    internal readonly unsafe struct Ptr_Func_GSGetConstantBuffers_81(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSGetConstantBuffers.
        /// </summary>
