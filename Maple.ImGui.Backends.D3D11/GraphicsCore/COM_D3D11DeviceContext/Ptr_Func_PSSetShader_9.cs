...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::PSSetShader function pointer (VTable slot 9).
    ...
    internal readonly unsafe struct Ptr_Func_PSSetShader_9(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::PSSetShader.
        /// </summary>
