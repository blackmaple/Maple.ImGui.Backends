...
{
    /// <summary>
    /// Wraps the ID3D11DeviceContext::GSSetConstantBuffers function pointer (VTable slot 22).
    ...
    internal readonly unsafe struct Ptr_Func_GSSetConstantBuffers_22(nint ptr) : Hook.Abstractions.IHookMethod
    {
        ...
        /// <summary>
        /// Invokes ID3D11DeviceContext::GSSetConstantBuffers.
        /// </summary>
