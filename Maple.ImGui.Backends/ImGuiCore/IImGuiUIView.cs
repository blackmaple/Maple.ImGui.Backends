...
namespace Maple.ImGui.Backends.ImGuiCore
{
    ...
    public delegate bool TryDrawLauncherDelegate();
    /// <summary>
    ...
    public interface IImGuiUIView
    {
        ...
        /// <summary>
        /// bool TryDrawImage(string? category, string objectId, string? image) => false;
        /// </summary>
        TryDrawImageDelegate? TryDrawImage { get; set; }
        TryDrawLauncherDelegate? TryDrawLauncher { get; set; }
