...
namespace Maple.ImGui.Backends.DXGI.HOOK_DXGISwapChain
{
    internal class DXGISetPrivateDataInterfaceHookItem : HookItem<DXGISetPrivateDataInterfaceHookItem, Ptr_Func_SetPrivateDataInterface_4, Ptr_Func_SetPrivateDataInterface_4>, IGraphicsHookItem<DXGISetPrivateDataInterfaceHookItem>
    {
        ...
        public static DXGISetPrivateDataInterfaceHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        {
            delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<IDXGISwapChainImp>, UnsafeIn<global::System.Guid>, UnsafePtr, COM_HRESULT>
