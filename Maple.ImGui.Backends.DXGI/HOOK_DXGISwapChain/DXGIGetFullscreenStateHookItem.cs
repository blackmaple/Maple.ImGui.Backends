...
namespace Maple.ImGui.Backends.DXGI.HOOK_DXGISwapChain
{
    internal class DXGIGetFullscreenStateHookItem : HookItem<DXGIGetFullscreenStateHookItem, Ptr_Func_GetFullscreenState_11, Ptr_Func_GetFullscreenState_11>, IGraphicsHookItem<DXGIGetFullscreenStateHookItem>
    {
        ...
        public static DXGIGetFullscreenStateHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        {
            delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<IDXGISwapChainImp>, UnsafeOut<BOOL>, UnsafeOut<UnsafePtr>, COM_HRESULT>
