...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9SetClipPlaneHookItem : HookItem<D3D9SetClipPlaneHookItem, Ptr_Func_SetClipPlane_55, Ptr_Func_SetClipPlane_55>, IGraphicsHookItem<D3D9SetClipPlaneHookItem>
    {
        ...
        public static D3D9SetClipPlaneHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_SetClipPlane(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint Index, UnmanagedExtensions.UnsafeRef<float> pPlane)
        {
