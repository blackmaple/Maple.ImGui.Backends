...
{
    internal class D3D9GetMaterialHookItem : HookItem<D3D9GetMaterialHookItem, Ptr_Func_GetMaterial_50, Ptr_Func_GetMaterial_50>, IGraphicsHookItem<D3D9GetMaterialHookItem>
    {
        ...
        public static D3D9GetMaterialHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_GetMaterial(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Graphics.Direct3D9.D3DMATERIAL9> pMaterial)
        {
