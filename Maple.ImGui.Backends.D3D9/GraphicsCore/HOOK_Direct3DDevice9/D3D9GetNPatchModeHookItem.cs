...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9GetNPatchModeHookItem : HookItem<D3D9GetNPatchModeHookItem, Ptr_Func_GetNPatchMode_80, Ptr_Func_GetNPatchMode_80>, IGraphicsHookItem<D3D9GetNPatchModeHookItem>
    {
        ...
        public Func<Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, float>? SyncCallback { get; set; }
        ...
        {
            delegate* unmanaged[Stdcall, SuppressGCTransition]<Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, float>
                _proc = &Hook_GetNPatchMode;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall),typeof(CallConvSuppressGCTransition)])]
        private static float Hook_GetNPatchMode(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this)
        {
