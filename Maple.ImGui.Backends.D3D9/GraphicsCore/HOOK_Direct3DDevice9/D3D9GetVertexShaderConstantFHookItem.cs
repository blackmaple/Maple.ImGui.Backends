...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9GetVertexShaderConstantFHookItem : HookItem<D3D9GetVertexShaderConstantFHookItem, Ptr_Func_GetVertexShaderConstantF_95, Ptr_Func_GetVertexShaderConstantF_95>, IGraphicsHookItem<D3D9GetVertexShaderConstantFHookItem>
    {
        ...
        public static D3D9GetVertexShaderConstantFHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9GetVertexShaderConstantFHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetVertexShaderConstantF(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint StartRegister, UnmanagedExtensions.UnsafeRef<float> pConstantData, uint Vector4fCount)
        {
