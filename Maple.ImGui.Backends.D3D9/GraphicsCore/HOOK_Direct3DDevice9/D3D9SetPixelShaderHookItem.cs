...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9SetPixelShaderHookItem : HookItem<D3D9SetPixelShaderHookItem, Ptr_Func_SetPixelShader_107, Ptr_Func_SetPixelShader_107>, IGraphicsHookItem<D3D9SetPixelShaderHookItem>
    {
        ...
        public static D3D9SetPixelShaderHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9SetPixelShaderHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_SetPixelShader(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, nint pShader)
        {
