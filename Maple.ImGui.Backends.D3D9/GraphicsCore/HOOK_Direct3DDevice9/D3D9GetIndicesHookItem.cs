...
{
    internal class D3D9GetIndicesHookItem : HookItem<D3D9GetIndicesHookItem, Ptr_Func_GetIndices_105, Ptr_Func_GetIndices_105>, IGraphicsHookItem<D3D9GetIndicesHookItem>
    {
        ...
        public static D3D9GetIndicesHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9GetIndicesHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetIndices(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnsafeOut<nint> ppIndexData)
        {
