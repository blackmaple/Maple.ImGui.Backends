...
{
    internal class D3D9SetTransformHookItem : HookItem<D3D9SetTransformHookItem, Ptr_Func_SetTransform_44, Ptr_Func_SetTransform_44>, IGraphicsHookItem<D3D9SetTransformHookItem>
    {
        ...
        public static D3D9SetTransformHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9SetTransformHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_SetTransform(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, D3DTRANSFORMSTATETYPE State, UnsafeRef<global::Windows.Win32.Graphics.Direct3D.D3DMATRIX> pMatrix)
        {
