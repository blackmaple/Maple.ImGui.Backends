...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9GetStreamSourceFreqHookItem : HookItem<D3D9GetStreamSourceFreqHookItem, Ptr_Func_GetStreamSourceFreq_103, Ptr_Func_GetStreamSourceFreq_103>, IGraphicsHookItem<D3D9GetStreamSourceFreqHookItem>
    {
        ...
        public Func<Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, uint, UnsafeRef<int>, COM_HRESULT>? SyncCallback { get; set; }

        public static D3D9GetStreamSourceFreqHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        {
            delegate* unmanaged[Stdcall, SuppressGCTransition]<Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, uint, UnsafeRef<int>, COM_HRESULT>
                _proc = &Hook_GetStreamSourceFreq;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall),typeof(CallConvSuppressGCTransition)])]
        private static COM_HRESULT Hook_GetStreamSourceFreq(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint StreamNumber, UnsafeRef<int> pDivider)
        {
