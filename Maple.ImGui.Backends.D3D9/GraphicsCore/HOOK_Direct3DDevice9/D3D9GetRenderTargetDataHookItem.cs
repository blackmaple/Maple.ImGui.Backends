...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9GetRenderTargetDataHookItem : HookItem<D3D9GetRenderTargetDataHookItem, Ptr_Func_GetRenderTargetData_32, Ptr_Func_GetRenderTargetData_32>, IGraphicsHookItem<D3D9GetRenderTargetDataHookItem>
    {
        ...
        public Func<Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, nint, nint, COM_HRESULT>? SyncCallback { get; set; }

        public static D3D9GetRenderTargetDataHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_GetRenderTargetData(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, nint pRenderTarget, nint pDestSurface)
        {
