...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9SetVertexShaderConstantIHookItem : HookItem<D3D9SetVertexShaderConstantIHookItem,Ptr_Func_SetVertexShaderConstantI_96, Ptr_Func_SetVertexShaderConstantI_96>, IGraphicsHookItem<D3D9SetVertexShaderConstantIHookItem>
    {
        ...
        public static D3D9SetVertexShaderConstantIHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_SetVertexShaderConstantI(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint StartRegister, UnmanagedExtensions.UnsafeRef<int> pConstantData, uint Vector4iCount)
        {
