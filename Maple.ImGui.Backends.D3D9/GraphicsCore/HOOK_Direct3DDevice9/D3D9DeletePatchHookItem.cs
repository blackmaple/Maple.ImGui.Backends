...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9DeletePatchHookItem : HookItem<D3D9DeletePatchHookItem, Ptr_Func_DeletePatch_117, Ptr_Func_DeletePatch_117>, IGraphicsHookItem<D3D9DeletePatchHookItem>
    {
        ...
        public Func<Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, uint, D3D9DeletePatchHookItem, COM_HRESULT>? SyncCallback { get; set; }

        public static D3D9DeletePatchHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9DeletePatchHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_DeletePatch(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint Handle)
        {
