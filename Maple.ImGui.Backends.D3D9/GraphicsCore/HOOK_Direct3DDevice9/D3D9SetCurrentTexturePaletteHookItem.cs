...
{
    internal class D3D9SetCurrentTexturePaletteHookItem : HookItem<D3D9SetCurrentTexturePaletteHookItem, Ptr_Func_SetCurrentTexturePalette_73, Ptr_Func_SetCurrentTexturePalette_73>, IGraphicsHookItem<D3D9SetCurrentTexturePaletteHookItem>
    {
        ...
        public static D3D9SetCurrentTexturePaletteHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9SetCurrentTexturePaletteHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_SetCurrentTexturePalette(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint PaletteNumber)
        {
