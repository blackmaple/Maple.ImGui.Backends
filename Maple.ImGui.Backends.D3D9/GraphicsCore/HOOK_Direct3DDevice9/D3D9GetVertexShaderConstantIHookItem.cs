...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9GetVertexShaderConstantIHookItem : HookItem<D3D9GetVertexShaderConstantIHookItem, Ptr_Func_GetVertexShaderConstantI_97, Ptr_Func_GetVertexShaderConstantI_97>, IGraphicsHookItem<D3D9GetVertexShaderConstantIHookItem>
    {
        ...
        public static D3D9GetVertexShaderConstantIHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9GetVertexShaderConstantIHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetVertexShaderConstantI(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint StartRegister, UnmanagedExtensions.UnsafeRef<int> pConstantData, uint Vector4iCount)
        {
