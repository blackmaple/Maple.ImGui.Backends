...
{
    internal class D3D9GetDepthStencilSurfaceHookItem : HookItem<D3D9GetDepthStencilSurfaceHookItem, Ptr_Func_GetDepthStencilSurface_40, Ptr_Func_GetDepthStencilSurface_40>, IGraphicsHookItem<D3D9GetDepthStencilSurfaceHookItem>
    {
        ...
        public static D3D9GetDepthStencilSurfaceHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9GetDepthStencilSurfaceHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetDepthStencilSurface(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnsafeOut<nint> ppZStencilSurface)
        {
