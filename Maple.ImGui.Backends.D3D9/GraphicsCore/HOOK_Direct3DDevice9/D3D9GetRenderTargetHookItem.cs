...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9GetRenderTargetHookItem : HookItem<D3D9GetRenderTargetHookItem, Ptr_Func_GetRenderTarget_38, Ptr_Func_GetRenderTarget_38>, IGraphicsHookItem<D3D9GetRenderTargetHookItem>
    {
        ...
        public static D3D9GetRenderTargetHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9GetRenderTargetHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetRenderTarget(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint RenderTargetIndex, UnmanagedExtensions.UnsafeOut<nint> ppRenderTarget)
        {
