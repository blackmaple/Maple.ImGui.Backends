...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9SetDepthStencilSurfaceHookItem : HookItem<D3D9SetDepthStencilSurfaceHookItem, Ptr_Func_SetDepthStencilSurface_39, Ptr_Func_SetDepthStencilSurface_39>, IGraphicsHookItem<D3D9SetDepthStencilSurfaceHookItem>
    {
        ...
        public static D3D9SetDepthStencilSurfaceHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9SetDepthStencilSurfaceHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_SetDepthStencilSurface(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, nint pNewZStencil)
        {
