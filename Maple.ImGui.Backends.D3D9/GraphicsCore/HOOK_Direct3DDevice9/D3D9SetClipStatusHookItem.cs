...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.HOOK_Direct3DDevice9
{
    internal class D3D9SetClipStatusHookItem : HookItem<D3D9SetClipStatusHookItem, Ptr_Func_SetClipStatus_62, Ptr_Func_SetClipStatus_62>, IGraphicsHookItem<D3D9SetClipStatusHookItem>
    {
        ...
        public static D3D9SetClipStatusHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9SetClipStatusHookItem>($"NOT FOUND {MethodName}");
            }
            var hookItemImp = hookFactory.Create<D3D9SetClipStatusHookItem>(
                functionPtr,
        ...
        private static COM_HRESULT Hook_SetClipStatus(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Graphics.Direct3D9.D3DCLIPSTATUS9> pClipStatus)
        {
