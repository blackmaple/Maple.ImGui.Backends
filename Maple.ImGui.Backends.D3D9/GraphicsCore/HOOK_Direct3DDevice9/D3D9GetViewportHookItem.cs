...
{
    internal class D3D9GetViewportHookItem : HookItem<D3D9GetViewportHookItem, Ptr_Func_GetViewport_48, Ptr_Func_GetViewport_48>, IGraphicsHookItem<D3D9GetViewportHookItem>
    {
        ...
        public static D3D9GetViewportHookItem Create(ISupperHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D9GetViewportHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetViewport(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Graphics.Direct3D9.D3DVIEWPORT9> pViewport)
        {
