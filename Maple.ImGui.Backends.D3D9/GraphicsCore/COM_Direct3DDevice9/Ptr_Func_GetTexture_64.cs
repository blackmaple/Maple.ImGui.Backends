...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.COM_Direct3DDevice9
{
    ...
    internal readonly unsafe struct Ptr_Func_GetTexture_64(nint ptr): Hook.Abstractions.IHookMethod
    {
        ...
        public COM_HRESULT Invoke(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> pThis, uint Stage, UnmanagedExtensions.UnsafeOut<nint> ppTexture) => _proc(pThis, Stage, ppTexture);
