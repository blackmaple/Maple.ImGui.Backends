...
namespace Maple.ImGui.Backends.D3D9.GraphicsCore.COM_Direct3DDevice9
{
    ...
    internal readonly unsafe struct Ptr_Func_SetSoftwareVertexProcessing_77(nint ptr): Hook.Abstractions.IHookMethod
    {
        ...
        public COM_HRESULT Invoke(Windows.GraphicsCore.COM.COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> pThis, int bFlag) => _proc(pThis, bFlag);
