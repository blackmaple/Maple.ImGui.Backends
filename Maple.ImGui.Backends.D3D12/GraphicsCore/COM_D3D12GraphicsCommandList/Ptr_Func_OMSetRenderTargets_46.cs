...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12GraphicsCommandList
{
    ...
    internal unsafe readonly struct Ptr_Func_OMSetRenderTargets_46(nint ptr) : IHookMethod
    {
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, uint, UnsafeRef<D3D12_CPU_DESCRIPTOR_HANDLE>, BOOL, UnsafeIn<D3D12_CPU_DESCRIPTOR_HANDLE>, void> _proc =
            (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, uint, UnsafeRef<D3D12_CPU_DESCRIPTOR_HANDLE>, BOOL, UnsafeIn<D3D12_CPU_DESCRIPTOR_HANDLE>, void>)ptr;
