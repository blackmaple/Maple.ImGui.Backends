...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12GraphicsCommandList
{
    ...
    [StructLayout(LayoutKind.Sequential)]
        internal unsafe readonly struct Ptr_Func_DrawInstanced_12(nint ptr) : IHookMethod
        {
            ...
            /// </summary>
            private readonly unsafe delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, uint, uint, uint, uint, void> _proc = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, uint, uint, uint, uint, void>)ptr;
