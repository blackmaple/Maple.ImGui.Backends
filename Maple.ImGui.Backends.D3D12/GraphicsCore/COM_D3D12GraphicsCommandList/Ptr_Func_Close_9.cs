...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12GraphicsCommandList
{
    ...
    [StructLayout(LayoutKind.Sequential)]
        internal unsafe readonly struct Ptr_Func_Close_9(nint ptr) : IHookMethod
        {
            ...
            /// </summary>
            private readonly unsafe delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, COM_HRESULT> _proc = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, COM_HRESULT>)ptr;
