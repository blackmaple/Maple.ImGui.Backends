...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12GraphicsCommandList
{
    ...
    internal unsafe readonly struct Ptr_Func_SetGraphicsRootUnorderedAccessView_42(nint ptr) : IHookMethod
    {
        public const string Name = "SetGraphicsRootUnorderedAccessView";
        /// <summary>
        /// public delegate* unmanaged[MemberFunction]<global::System.Runtime.InteropServices.ComWrappers.ComInterfaceDispatch*, uint, ulong, void> SetGraphicsRootUnorderedAccessView_42;
        /// </summary>
