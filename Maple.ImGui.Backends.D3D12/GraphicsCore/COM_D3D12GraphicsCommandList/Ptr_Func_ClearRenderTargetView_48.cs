...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12GraphicsCommandList
{
    ...
    internal unsafe readonly struct Ptr_Func_ClearRenderTargetView_48(nint ptr) : IHookMethod
    {
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, D3D12_CPU_DESCRIPTOR_HANDLE, float*, uint, RECT*, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, D3D12_CPU_DESCRIPTOR_HANDLE, float*, uint, RECT*, void>)ptr;
