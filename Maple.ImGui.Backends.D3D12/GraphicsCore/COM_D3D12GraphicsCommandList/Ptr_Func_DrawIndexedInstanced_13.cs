...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12GraphicsCommandList
{
    ...
    [StructLayout(LayoutKind.Sequential)]
        internal unsafe readonly struct Ptr_Func_DrawIndexedInstanced_13(nint ptr) : IHookMethod
        {
            ...
            /// </summary>
            private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, uint, uint, uint, int, uint, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12GraphicsCommandListImp>, uint, uint, uint, int, uint, void>)ptr;
