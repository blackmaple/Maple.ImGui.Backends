...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateCommandSignature_41(nint ptr) : IHookMethod
    {
        public const string Name = "CreateCommandSignature";
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, D3D12_COMMAND_SIGNATURE_DESC*, void*, Guid*, void**, COM_HRESULT> _proc = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, D3D12_COMMAND_SIGNATURE_DESC*, void*, Guid*, void**, COM_HRESULT>)ptr;

        public nint PtrMethod => (nint)_proc;
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, D3D12_COMMAND_SIGNATURE_DESC* pDesc, void* pRootSignature, Guid* riid, void** ppvCommandSignature) => _proc(pThis, pDesc, pRootSignature, riid, ppvCommandSignature);
