...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateUnorderedAccessView_19(nint ptr) : IHookMethod
    {
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, void*, void*, D3D12_UNORDERED_ACCESS_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, void*, void*, D3D12_UNORDERED_ACCESS_VIEW_DESC*, D3D12_CPU_DESCRIPTOR_HANDLE, void>)ptr;

        public nint PtrMethod => (nint)_proc;
        public unsafe void Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, void* pResource, void* pCounterResource, D3D12_UNORDERED_ACCESS_VIEW_DESC* pDesc, D3D12_CPU_DESCRIPTOR_HANDLE destDescriptor) => _proc(pThis, pResource, pCounterResource, pDesc, destDescriptor);
