...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateDescriptorHeap_14(nint ptr) : IHookMethod
    {
        public const string Name = "CreateDescriptorHeap";
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, UnsafeIn<D3D12_DESCRIPTOR_HEAP_DESC>, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT> _proc =
            (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, UnsafeIn<D3D12_DESCRIPTOR_HEAP_DESC>, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT>)ptr;

        public nint PtrMethod => (nint)_proc;
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, UnsafeIn<D3D12_DESCRIPTOR_HEAP_DESC> pDescriptorHeapDesc, UnsafeIn<Guid> riid, UnsafeOut<COM_PTR_IUNKNOWN> ppvHeap)
            => _proc(pThis, pDescriptorHeapDesc, riid, ppvHeap);
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, in D3D12_DESCRIPTOR_HEAP_DESC pDescriptorHeapDesc, in Guid riid, out COM_PTR_IUNKNOWN ppvHeap)
            => _proc(pThis, UnsafeIn<D3D12_DESCRIPTOR_HEAP_DESC>.FromIn(in pDescriptorHeapDesc), UnsafeIn<Guid>.FromIn(in riid), UnsafeOut<COM_PTR_IUNKNOWN>.FromOut(out ppvHeap));
