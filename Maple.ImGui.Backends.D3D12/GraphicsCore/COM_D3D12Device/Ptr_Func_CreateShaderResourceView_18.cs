...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateShaderResourceView_18(nint ptr) : IHookMethod
    {
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, COM_PTR_IUNKNOWN, UnsafeIn<D3D12_SHADER_RESOURCE_VIEW_DESC>, D3D12_CPU_DESCRIPTOR_HANDLE, void> _proc
            = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, COM_PTR_IUNKNOWN, UnsafeIn<D3D12_SHADER_RESOURCE_VIEW_DESC>, D3D12_CPU_DESCRIPTOR_HANDLE, void>)ptr;
