...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateCommandAllocator_9(nint ptr) : IHookMethod
    {
        public const string Name = "CreateCommandAllocator";
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, D3D12_COMMAND_LIST_TYPE, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT> _proc =
            (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, D3D12_COMMAND_LIST_TYPE, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT>)ptr;

        public nint PtrMethod => (nint)_proc;
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, D3D12_COMMAND_LIST_TYPE type, UnsafeIn<Guid> riid, UnsafeOut<COM_PTR_IUNKNOWN> ppCommandAllocator) => _proc(pThis, type, riid, ppCommandAllocator);
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, D3D12_COMMAND_LIST_TYPE type, in Guid riid, out COM_PTR_IUNKNOWN ppCommandAllocator) =>
            _proc(pThis, type, UnsafeIn<Guid>.FromIn(riid), UnsafeOut<COM_PTR_IUNKNOWN>.FromOut(out ppCommandAllocator));
