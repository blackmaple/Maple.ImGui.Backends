...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateCommandQueue_8(nint ptr) : IHookMethod
    {
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, UnsafeIn<D3D12_COMMAND_QUEUE_DESC>, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT> _proc =
            (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, UnsafeIn<D3D12_COMMAND_QUEUE_DESC>, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT>)ptr;
