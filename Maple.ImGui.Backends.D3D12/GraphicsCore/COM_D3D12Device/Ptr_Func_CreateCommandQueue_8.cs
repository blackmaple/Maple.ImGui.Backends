...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateCommandQueue_8(nint ptr) : IHookMethod
    {
        public const string Name = "CreateCommandQueue";
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, UnsafeIn<D3D12_COMMAND_QUEUE_DESC>, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT> _proc =
            (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, UnsafeIn<D3D12_COMMAND_QUEUE_DESC>, UnsafeIn<Guid>, UnsafeOut<COM_PTR_IUNKNOWN>, COM_HRESULT>)ptr;

        public nint PtrMethod => (nint)_proc;
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, UnsafeIn<D3D12_COMMAND_QUEUE_DESC> pDesc, UnsafeIn<Guid> riid, UnsafeOut<COM_PTR_IUNKNOWN> ppCommandQueue) => _proc(pThis, pDesc, riid, ppCommandQueue);
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, in D3D12_COMMAND_QUEUE_DESC pDesc, in Guid riid, out COM_PTR_IUNKNOWN ppCommandQueue)
            => _proc(pThis, UnsafeIn<D3D12_COMMAND_QUEUE_DESC>.FromIn(in pDesc), UnsafeIn<Guid>.FromIn(in riid), UnsafeOut<COM_PTR_IUNKNOWN>.FromOut(out ppCommandQueue));
