...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateCommandList_12(nint ptr) : IHookMethod
    {
        public const string Name = "CreateCommandList";
        ...
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, uint nodeMask, D3D12_COMMAND_LIST_TYPE type, COM_PTR_IUNKNOWN pCommandAllocator, COM_PTR_IUNKNOWN pInitialCommandList, UnsafeIn<Guid> riid, UnsafeOut<COM_PTR_IUNKNOWN> ppCommandList)
            => _proc(pThis, nodeMask, type, pCommandAllocator, pInitialCommandList, riid, ppCommandList);
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, uint nodeMask, D3D12_COMMAND_LIST_TYPE type,
            COM_PTR_IUNKNOWN pCommandAllocator, COM_PTR_IUNKNOWN pInitialCommandList, in Guid riid, out COM_PTR_IUNKNOWN ppCommandList)
            => _proc(pThis, nodeMask, type, pCommandAllocator, pInitialCommandList, UnsafeIn<Guid>.FromIn(in riid), UnsafeOut<COM_PTR_IUNKNOWN>.FromOut(out ppCommandList));
