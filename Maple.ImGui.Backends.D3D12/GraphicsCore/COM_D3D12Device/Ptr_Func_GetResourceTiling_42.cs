...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_GetResourceTiling_42(nint ptr) : IHookMethod
    {
        public const string Name = "GetResourceTiling";
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, void*, uint*, D3D12_PACKED_MIP_INFO*, D3D12_TILE_SHAPE*, uint*, uint, D3D12_SUBRESOURCE_TILING*, void> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12DeviceImp>, void*, uint*, D3D12_PACKED_MIP_INFO*, D3D12_TILE_SHAPE*, uint*, uint, D3D12_SUBRESOURCE_TILING*, void>)ptr;

        public nint PtrMethod => (nint)_proc;
        public unsafe void Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, void* pResource, uint* pTotalTiles, D3D12_PACKED_MIP_INFO* pPackedMipDesc, D3D12_TILE_SHAPE* pStandardTileShape, uint* pNumSubresourceTilings, uint firstSubresourceTilingToGet, D3D12_SUBRESOURCE_TILING* pSubresourceTilings) => _proc(pThis, pResource, pTotalTiles, pPackedMipDesc, pStandardTileShape, pNumSubresourceTilings, firstSubresourceTilingToGet, pSubresourceTilings);
