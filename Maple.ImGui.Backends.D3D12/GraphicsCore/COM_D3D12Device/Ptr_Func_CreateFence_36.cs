...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12Device
{
    ...
    internal unsafe readonly struct Ptr_Func_CreateFence_36(nint ptr) : IHookMethod
    {
        public const string Name = "CreateFence";
        ...
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12DeviceImp> pThis, ulong initialValue, D3D12_FENCE_FLAGS flags, UnsafeIn<Guid> riid, UnsafeOut<COM_PTR_IUNKNOWN> ppFence)
            => _proc(pThis, initialValue, flags, riid, ppFence);
