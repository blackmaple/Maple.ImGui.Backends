...
namespace Maple.ImGui.Backends.D3D12.GraphicsCore.COM_D3D12CommandAllocator
{
    ...
    internal unsafe readonly struct Ptr_Func_SetName_6(nint ptr) : IHookMethod
    {
        ...
        /// </summary>
        private readonly unsafe delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12CommandAllocatorImp>, PCWSTR, COM_HRESULT> _proc = (delegate* unmanaged[Stdcall, SuppressGCTransition]<COM_PTR_IUNKNOWN<ID3D12CommandAllocatorImp>, PCWSTR, COM_HRESULT>)ptr;
        public nint PtrMethod => (nint)_proc;
        public unsafe COM_HRESULT Invoke(COM_PTR_IUNKNOWN<ID3D12CommandAllocatorImp> pThis, PCWSTR name) => _proc(pThis, name);
